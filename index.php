...
<head>
  <meta charset="UTF-8" />
  <title>CodePen - Login Page Form</title>
    ...
    <form action="cek_login.php" method="POST">
      <div class="login">
        <label>
          ...
          <input class="username" name="email" type="text" autocomplete="on" placeholder="email" />
        </label>
        <label>
          <div class="fa fa-commenting"></div>
          <input class="password" name="password" type="password" autocomplete="off" placeholder="password" />
          <button class="password-button">Lihat</button>
        </label>
      ...
      <div class="footer"><a href="daftar.php">Daftar</a></div>
    </form>
  </div>

  <a class="inspiration" href="https://dribbble.com/shots/4485321-Login-Page-Homepage" target="_blank" rel="noopener"><img src="https://cdn.dribbble.com/assets/logo-footer-hd-a05db77841b4b27c0bf23ec1378e97c988190dfe7d26e32e1faea7269f9e001b.png" alt="inspiration" /></a>
  <!-- partial -->
